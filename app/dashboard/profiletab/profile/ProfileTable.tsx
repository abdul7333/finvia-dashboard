...
import AddProfile from "./context/AddProfile";
import EditProfile from "./context/EditProfile";
...
const ProfileTable = () => {
    ...
    const handleEditSubmitForm = (payload: Profile) => {
        UpdateProfile(payload);

        setisEdit(false);
    };
    const handleAddSubmitForm = (payload: Profile) => {
        crateProfile(payload);
        ...
        <div>
            <div className={styles.TableFlexTop}>
                ...
                <div className={styles.TableButtonContainer}>
                    ...
                    <div>
                        {myPermissions?.permission.profile.create ? (
                            <Button
                                variant="contained"
                                    ...
                                    {tableData && tableData.length > 0 ? (
                                        tableData.map((row: Profile) => (
                                            ...
                                            >
                                                ...
                                                <TableCell align="left">
                                                    {myPermissions?.permission.profile.edit ?
                                                        <Button
                                                            onClick={() => {
                                                                setProfile(() => row);
                                                                setisEdit(true);
